...
const createRoutine = require('../createRoutine.js').main;
const getRoutine = require('../getRoutine.js').main;
const listRoutines = require('../listRoutines.js').main;
const updateRoutine = require('../updateRoutine.js').main;
const deleteRoutine = require('../deleteRoutine.js').main;
...
describe('Routines', () => {
  ...
  describe('Delete Routine', () => {
    ...
    it('should delete a routine', async () => {
      const output = await execSample(deleteRoutine, datasetId, routineId);
