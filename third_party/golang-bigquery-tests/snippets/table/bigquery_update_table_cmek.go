...
func updateTableChangeCMEK(projectID, datasetID, tableID string) error {
	...
	update := bigquery.TableMetadataToUpdate{
		EncryptionConfig: &bigquery.EncryptionConfig{
			// TODO: Replace with your Cloud KMS key (see bqtestutil.EmulatorCMEKKeyUSCentral for emulator tests).
			KMSKeyName: bqtestutil.EmulatorCMEKKeyUSCentral(projectID, "otherkey"),
		},
	}
