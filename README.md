...
[![release](https://img.shields.io/github/v/release/vantaboard/bigquery-emulator)](https://github.com/vantaboard/bigquery-emulator/releases/latest)
...
### Ratio vs BigQuery baseline (vantaboard)

![Vantaboard server p50 as a multiple of BigQuery job duration (log scale, capped at 10×)](./bench/charts/out/ratio.svg)

### Ratio vs BigQuery baseline (goccy)

![Goccy wall-clock p50 as a multiple of BigQuery job duration (log scale, capped at 10×)](./bench/charts/out/ratio_goccy.svg)

### Support matrix

![Per-case outcome by target (ok, error, wrong_result, timeout, skipped)](./bench/charts/out/support_matrix.svg)
