...
todos:
  ...
  - id: tp11
    ...
    status: pending
  - id: tp12
    content: "thirdparty-12-routines-crud.plan.md — implement Routines CRUD against a new storage routine registry (~1 wk; coordinates with local-exec-15-specialized-stubs.plan.md for query-time lookup)."
    status: pending
  - id: tp13
...
- **12**: Routines CRUD. Adds a storage routine registry and wires
  ...
  query-time UDF lookup tracks (`local-exec-15-specialized-stubs.plan.md`,
