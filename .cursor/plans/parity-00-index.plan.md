...
| 12 | done (MATCH_RECOGNIZE deferred) | 148→152 total, 142→146 pass (+4 fixtures; 6 scripting pre-existing) | dd0bc91, 739e846 | inline lambda + NET/HLL + approximate aggregates landed (dd0bc91); pipe subpipelines (IF/FORK/TEE/INSERT), FLATTEN, GROUP ROWS, pipe DML/DDL landed (739e846). MATCH_RECOGNIZE remains `status=planned` (carried into the `full-*` plan set). |
