...
| 09 | done | 142→145 total, 136→139 pass (+3 ddl fixtures; 6 scripting pre-existing) | pending commit | ALTER TABLE→control_op, MV full refresh, EXPORT/LOAD local file://, tracker+ROADMAP flips; ResolvedCatalogColumnRef still (planned) — no landed DDL shape references it |
| 10 | pending | — | | |
| 11 | pending | — | | |
| 12 | pending | — | | |
