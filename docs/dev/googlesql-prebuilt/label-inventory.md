...
| `@googlesql//googlesql/public:formatter_options`    | `formatter_options.h`                                                     | Expose | `backend/sqltools` passes formatter options into `LenientFormatSql`. |
...
| `@googlesql//googlesql/public:lenient_formatter`      | `lenient_formatter.h`                                                     | Expose | `backend/sqltools` pretty-prints SQL for downstream UIs (comment-preserving). |
| `@googlesql//googlesql/public:parse_helpers`          | `parse_helpers.h`, `parse_tokens.h`                                       | Expose | `backend/sqltools` parse/tokenize/complete helpers. |
...
| `@googlesql//googlesql/public:sql_formatter`          | `sql_formatter.h`                                                         | Expose | Strict SQL formatter mode in `backend/sqltools`. |
