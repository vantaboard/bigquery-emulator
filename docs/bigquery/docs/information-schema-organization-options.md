...
|---|---|---|
| `https://docs.cloud.google.com/bigquery/docs/information-schema-organization-options#options_table` | `STRING` | One of the name values in the [options table](https://docs.cloud.google.com/bigquery/docs/information-schema-organization-options#options_table). |
