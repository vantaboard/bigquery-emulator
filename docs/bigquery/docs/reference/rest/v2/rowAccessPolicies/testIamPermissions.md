# Method: rowAccessPolicies.testIamPermissions
...
If successful, the response body contains an instance of `https://docs.cloud.google.com/bigquery/docs/reference/rest/v2/TestIamPermissionsResponse`.
