...
A subquery is a [query](https://docs.cloud.google.com/bigquery/docs/reference/standard-sql/query-syntax) that appears inside another
...
[correlated](https://docs.cloud.google.com/bigquery/docs/reference/standard-sql/subqueries#correlated_subquery_concepts).
...
players, using the [`Players`](https://docs.cloud.google.com/bigquery/docs/reference/standard-sql/subqueries#example_tables) and [`Mascots`](https://docs.cloud.google.com/bigquery/docs/reference/standard-sql/subqueries#example_tables)
tables:
...
[`Players`](https://docs.cloud.google.com/bigquery/docs/reference/standard-sql/subqueries#example_tables) table.
...
red team in the [`NPCs`](https://docs.cloud.google.com/bigquery/docs/reference/standard-sql/subqueries#example_tables) table:
...
`corba` exists within the [`Players`](https://docs.cloud.google.com/bigquery/docs/reference/standard-sql/subqueries#example_tables) table:
...
produced, using the [`Players`](https://docs.cloud.google.com/bigquery/docs/reference/standard-sql/subqueries#example_tables) table:
...
In this example, a list of [`NPCs`](https://docs.cloud.google.com/bigquery/docs/reference/standard-sql/subqueries#example_tables)
...
more about this [here](https://docs.cloud.google.com/bigquery/docs/reference/standard-sql/subqueries#evaluation_rules_subqueries).

**Examples**

In this example, a list of mascots that don't have any players assigned to them
are returned. The [`Mascots`](https://docs.cloud.google.com/bigquery/docs/reference/standard-sql/subqueries#example_tables) and [`Players`](https://docs.cloud.google.com/bigquery/docs/reference/standard-sql/subqueries#example_tables)
