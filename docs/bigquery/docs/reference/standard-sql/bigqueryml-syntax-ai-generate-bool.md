...
- `ENDPOINT`: a `STRING` value that specifies the Vertex AI
  ...
  [Disable the thinking budget](https://docs.cloud.google.com/bigquery/docs/reference/standard-sql/bigqueryml-syntax-ai-generate-bool#thinking-budget).
...
To determine which animals are mammals, call the `AI.GENERATE_BOOL` function
