...
| [`GENERATE_DATE_ARRAY`](https://docs.cloud.google.com/bigquery/docs/reference/standard-sql/array_functions#generate_date_array) | Generates an array of dates in a range. For more information, see [Array functions](https://docs.cloud.google.com/bigquery/docs/reference/standard-sql/array_functions). |
...
- `time_zone`: A time zone to use with the `TIMESTAMP` value.
  [Time zone parts](https://docs.cloud.google.com/bigquery/docs/reference/standard-sql/date_functions#date_time_zone_parts) can be used.
