...
|---|---|---|
| Constructors | [`ST_GEOGPOINT`](https://docs.cloud.google.com/bigquery/docs/reference/standard-sql/geography_functions#st_geogpoint) [`ST_MAKELINE`](https://docs.cloud.google.com/bigquery/docs/reference/standard-sql/geography_functions#st_makeline) [`ST_MAKEPOLYGON`](https://docs.cloud.google.com/bigquery/docs/reference/standard-sql/geography_functions#st_makepolygon) [`ST_MAKEPOLYGONORIENTED`](https://docs.cloud.google.com/bigquery/docs/reference/standard-sql/geography_functions#st_makepolygonoriented) | Functions that build new geography values from coordinates or existing geographies. |
| Parsers | [`ST_GEOGFROM`](https://docs.cloud.google.com/bigquery/docs/reference/standard-sql/geography_functions#st_geogfrom) [`ST_GEOGFROMGEOJSON`](https://docs.cloud.google.com/bigquery/docs/reference/standard-sql/geography_functions#st_geogfromgeojson) [`ST_GEOGFROMTEXT`](https://docs.cloud.google.com/bigquery/docs/reference/standard-sql/geography_functions#st_geogfromtext) [`ST_GEOGFROMWKB`](https://docs.cloud.google.com/bigquery/docs/reference/standard-sql/geography_functions#st_geogfromwkb) [`ST_GEOGPOINTFROMGEOHASH`](https://docs.cloud.google.com/bigquery/docs/reference/standard-sql/geography_functions#st_geogpointfromgeohash) | Functions that create geographies from an external format such as [WKT](https://en.wikipedia.org/wiki/Well-known_text) and [GeoJSON](https://en.wikipedia.org/wiki/GeoJSON). |
| Formatters | [`ST_ASBINARY`](https://docs.cloud.google.com/bigquery/docs/reference/standard-sql/geography_functions#st_asbinary) [`ST_ASGEOJSON`](https://docs.cloud.google.com/bigquery/docs/reference/standard-sql/geography_functions#st_asgeojson) [`ST_ASTEXT`](https://docs.cloud.google.com/bigquery/docs/reference/standard-sql/geography_functions#st_astext) [`ST_GEOHASH`](https://docs.cloud.google.com/bigquery/docs/reference/standard-sql/geography_functions#st_geohash) | Functions that export geographies to an external format such as WKT. |
| Transformations | [`ST_BOUNDARY`](https://docs.cloud.google.com/bigquery/docs/reference/standard-sql/geography_functions#st_boundary) [`ST_BUFFER`](https://docs.cloud.google.com/bigquery/docs/reference/standard-sql/geography_functions#st_buffer) [`ST_BUFFERWITHTOLERANCE`](https://docs.cloud.google.com/bigquery/docs/reference/standard-sql/geography_functions#st_bufferwithtolerance) [`ST_CENTROID`](https://docs.cloud.google.com/bigquery/docs/reference/standard-sql/geography_functions#st_centroid) [`ST_CENTROID_AGG`](https://docs.cloud.google.com/bigquery/docs/reference/standard-sql/geography_functions#st_centroid_agg) (Aggregate) [`ST_CLOSESTPOINT`](https://docs.cloud.google.com/bigquery/docs/reference/standard-sql/geography_functions#st_closestpoint) [`ST_CONVEXHULL`](https://docs.cloud.google.com/bigquery/docs/reference/standard-sql/geography_functions#st_convexhull) [`ST_DIFFERENCE`](https://docs.cloud.google.com/bigquery/docs/reference/standard-sql/geography_functions#st_difference) [`ST_EXTERIORRING`](https://docs.cloud.google.com/bigquery/docs/reference/standard-sql/geography_functions#st_exteriorring) [`ST_INTERIORRINGS`](https://docs.cloud.google.com/bigquery/docs/reference/standard-sql/geography_functions#st_interiorrings) [`ST_INTERSECTION`](https://docs.cloud.google.com/bigquery/docs/reference/standard-sql/geography_functions#st_intersection) [`ST_LINEINTERPOLATEPOINT`](https://docs.cloud.google.com/bigquery/docs/reference/standard-sql/geography_functions#st_lineinterpolatepoint) [`ST_LINESUBSTRING`](https://docs.cloud.google.com/bigquery/docs/reference/standard-sql/geography_functions#st_linesubstring) [`ST_SIMPLIFY`](https://docs.cloud.google.com/bigquery/docs/reference/standard-sql/geography_functions#st_simplify) [`ST_SNAPTOGRID`](https://docs.cloud.google.com/bigquery/docs/reference/standard-sql/geography_functions#st_snaptogrid) [`ST_UNION`](https://docs.cloud.google.com/bigquery/docs/reference/standard-sql/geography_functions#st_union) [`ST_UNION_AGG`](https://docs.cloud.google.com/bigquery/docs/reference/standard-sql/geography_functions#st_union_agg) (Aggregate) | Functions that generate a new geography based on input. |
| Accessors | [`ST_DIMENSION`](https://docs.cloud.google.com/bigquery/docs/reference/standard-sql/geography_functions#st_dimension) [`ST_DUMP`](https://docs.cloud.google.com/bigquery/docs/reference/standard-sql/geography_functions#st_dump) [`ST_ENDPOINT`](https://docs.cloud.google.com/bigquery/docs/reference/standard-sql/geography_functions#st_endpoint) [`ST_GEOMETRYTYPE`](https://docs.cloud.google.com/bigquery/docs/reference/standard-sql/geography_functions#st_geometrytype) [`ST_ISCLOSED`](https://docs.cloud.google.com/bigquery/docs/reference/standard-sql/geography_functions#st_isclosed) [`ST_ISCOLLECTION`](https://docs.cloud.google.com/bigquery/docs/reference/standard-sql/geography_functions#st_iscollection) [`ST_ISEMPTY`](https://docs.cloud.google.com/bigquery/docs/reference/standard-sql/geography_functions#st_isempty) [`ST_ISRING`](https://docs.cloud.google.com/bigquery/docs/reference/standard-sql/geography_functions#st_isring) [`ST_NPOINTS`](https://docs.cloud.google.com/bigquery/docs/reference/standard-sql/geography_functions#st_npoints) [`ST_NUMGEOMETRIES`](https://docs.cloud.google.com/bigquery/docs/reference/standard-sql/geography_functions#st_numgeometries) [`ST_NUMPOINTS`](https://docs.cloud.google.com/bigquery/docs/reference/standard-sql/geography_functions#st_numpoints) [`ST_POINTN`](https://docs.cloud.google.com/bigquery/docs/reference/standard-sql/geography_functions#st_pointn) [`ST_STARTPOINT`](https://docs.cloud.google.com/bigquery/docs/reference/standard-sql/geography_functions#st_startpoint) [`ST_X`](https://docs.cloud.google.com/bigquery/docs/reference/standard-sql/geography_functions#st_x) [`ST_Y`](https://docs.cloud.google.com/bigquery/docs/reference/standard-sql/geography_functions#st_y) | Functions that provide access to properties of a geography without side-effects. |
| Predicates | [`ST_CONTAINS`](https://docs.cloud.google.com/bigquery/docs/reference/standard-sql/geography_functions#st_contains) [`ST_COVEREDBY`](https://docs.cloud.google.com/bigquery/docs/reference/standard-sql/geography_functions#st_coveredby) [`ST_COVERS`](https://docs.cloud.google.com/bigquery/docs/reference/standard-sql/geography_functions#st_covers) [`ST_DISJOINT`](https://docs.cloud.google.com/bigquery/docs/reference/standard-sql/geography_functions#st_disjoint) [`ST_DWITHIN`](https://docs.cloud.google.com/bigquery/docs/reference/standard-sql/geography_functions#st_dwithin) [`ST_EQUALS`](https://docs.cloud.google.com/bigquery/docs/reference/standard-sql/geography_functions#st_equals) [`ST_HAUSDORFFDWITHIN`](https://docs.cloud.google.com/bigquery/docs/reference/standard-sql/geography_functions#st_hausdorffdwithin) [`ST_INTERSECTS`](https://docs.cloud.google.com/bigquery/docs/reference/standard-sql/geography_functions#st_intersects) [`ST_INTERSECTSBOX`](https://docs.cloud.google.com/bigquery/docs/reference/standard-sql/geography_functions#st_intersectsbox) [`ST_TOUCHES`](https://docs.cloud.google.com/bigquery/docs/reference/standard-sql/geography_functions#st_touches) [`ST_WITHIN`](https://docs.cloud.google.com/bigquery/docs/reference/standard-sql/geography_functions#st_within) | Functions that return `TRUE` or `FALSE` for some spatial relationship between two geographies or some property of a geography. These functions are commonly used in filter clauses. |
| Measures | [`ST_ANGLE`](https://docs.cloud.google.com/bigquery/docs/reference/standard-sql/geography_functions#st_angle) [`ST_AREA`](https://docs.cloud.google.com/bigquery/docs/reference/standard-sql/geography_functions#st_area) [`ST_AZIMUTH`](https://docs.cloud.google.com/bigquery/docs/reference/standard-sql/geography_functions#st_azimuth) [`ST_BOUNDINGBOX`](https://docs.cloud.google.com/bigquery/docs/reference/standard-sql/geography_functions#st_boundingbox) [`ST_DISTANCE`](https://docs.cloud.google.com/bigquery/docs/reference/standard-sql/geography_functions#st_distance) [`ST_EXTENT`](https://docs.cloud.google.com/bigquery/docs/reference/standard-sql/geography_functions#st_extent) (Aggregate) [`ST_HAUSDORFFDISTANCE`](https://docs.cloud.google.com/bigquery/docs/reference/standard-sql/geography_functions#st_hausdorffdistance) [`ST_LINELOCATEPOINT`](https://docs.cloud.google.com/bigquery/docs/reference/standard-sql/geography_functions#st_linelocatepoint) [`ST_LENGTH`](https://docs.cloud.google.com/bigquery/docs/reference/standard-sql/geography_functions#st_length) [`ST_MAXDISTANCE`](https://docs.cloud.google.com/bigquery/docs/reference/standard-sql/geography_functions#st_maxdistance) [`ST_PERIMETER`](https://docs.cloud.google.com/bigquery/docs/reference/standard-sql/geography_functions#st_perimeter) | Functions that compute measurements of one or more geographies. |
| Clustering | [`ST_CLUSTERDBSCAN`](https://docs.cloud.google.com/bigquery/docs/reference/standard-sql/geography_functions#st_clusterdbscan) | Functions that perform clustering on geographies. |
| S2 functions | [`S2_CELLIDFROMPOINT`](https://docs.cloud.google.com/bigquery/docs/reference/standard-sql/geography_functions#s2_cellidfrompoint) [`S2_COVERINGCELLIDS`](https://docs.cloud.google.com/bigquery/docs/reference/standard-sql/geography_functions#s2_coveringcellids) | Functions for working with S2 cell coverings of GEOGRAPHY. |
| Raster functions | [`ST_REGIONSTATS`](https://docs.cloud.google.com/bigquery/docs/reference/standard-sql/geography_functions#st_regionstats) | Functions for analyzing geospatial rasters using geographies. |
...
- To compute the covering of a complex `GEOGRAPHY`, use [S2_COVERINGCELLIDS](https://docs.cloud.google.com/bigquery/docs/reference/standard-sql/geography_functions#s2_coveringcellids).
...
See [`ST_GEOGFROMWKB`](https://docs.cloud.google.com/bigquery/docs/reference/standard-sql/geography_functions#st_geogfromwkb) to construct a
`GEOGRAPHY` from WKB.
...
See [`ST_GEOGFROMGEOJSON`](https://docs.cloud.google.com/bigquery/docs/reference/standard-sql/geography_functions#st_geogfromgeojson) to construct a
...
See [`ST_GEOGFROMTEXT`](https://docs.cloud.google.com/bigquery/docs/reference/standard-sql/geography_functions#st_geogfromtext) to construct a
`GEOGRAPHY` from WKT.
...
This function is similar to [`ST_BUFFERWITHTOLERANCE`](https://docs.cloud.google.com/bigquery/docs/reference/standard-sql/geography_functions#st_bufferwithtolerance),
...
eight sides and [`ST_NUMPOINTS`](https://docs.cloud.google.com/bigquery/docs/reference/standard-sql/geography_functions#st_numpoints) returns nine vertices. When
...
[`ST_NUMPOINTS`](https://docs.cloud.google.com/bigquery/docs/reference/standard-sql/geography_functions#st_numpoints) returns thirty-three vertices.
...
Returns a `GEOGRAPHY` that represents the buffer around the input `GEOGRAPHY`.
This function is similar to [`ST_BUFFER`](https://docs.cloud.google.com/bigquery/docs/reference/standard-sql/geography_functions#st_buffer),
...
See [`ST_CENTROID`](https://docs.cloud.google.com/bigquery/docs/reference/standard-sql/geography_functions#st_centroid) for the non-aggregate version of
...
[`ST_COVERS`](https://docs.cloud.google.com/bigquery/docs/reference/standard-sql/geography_functions#st_covers)`(b, a)`. Note the opposite order of arguments.
...
- WKT format. To learn more about this format and the requirements to use it, see [ST_GEOGFROMTEXT](https://docs.cloud.google.com/bigquery/docs/reference/standard-sql/geography_functions#st_geogfromtext).
- WKB in hexadecimal text format. To learn more about this format and the requirements to use it, see [ST_GEOGFROMWKB](https://docs.cloud.google.com/bigquery/docs/reference/standard-sql/geography_functions#st_geogfromwkb).
- GeoJSON format. To learn more about this format and the requirements to use it, see [ST_GEOGFROMGEOJSON](https://docs.cloud.google.com/bigquery/docs/reference/standard-sql/geography_functions#st_geogfromgeojson).
...
requirements to use it, see [ST_GEOGFROMWKB](https://docs.cloud.google.com/bigquery/docs/reference/standard-sql/geography_functions#st_geogfromwkb).
...
See [`ST_ASGEOJSON`](https://docs.cloud.google.com/bigquery/docs/reference/standard-sql/geography_functions#st_asgeojson) to format a
...
- `oriented`: A named argument with a `BOOL` literal.
  ...
  - If the value is `TRUE`, any polygons in the input are assumed to be
    ...
    hemisphere. See also [`ST_MAKEPOLYGONORIENTED`](https://docs.cloud.google.com/bigquery/docs/reference/standard-sql/geography_functions#st_makepolygonoriented),
...
printed for [ST_ASTEXT](https://docs.cloud.google.com/bigquery/docs/reference/standard-sql/geography_functions#st_astext) and [ST_ASGEOJSON](https://docs.cloud.google.com/bigquery/docs/reference/standard-sql/geography_functions#st_asgeojson).
...
Returns `TRUE` if the [Hausdorff distance](https://docs.cloud.google.com/bigquery/docs/reference/standard-sql/geography_functions#st_hausdorffdistance) between `geography_1` and
...
See [ST_INTERSECTS](https://docs.cloud.google.com/bigquery/docs/reference/standard-sql/geography_functions#st_intersects), [ST_DISJOINT](https://docs.cloud.google.com/bigquery/docs/reference/standard-sql/geography_functions#st_disjoint) for related
predicate functions.
...
If `ST_INTERSECTS` returns `TRUE`, it implies that [`ST_DISJOINT`](https://docs.cloud.google.com/bigquery/docs/reference/standard-sql/geography_functions#st_disjoint)
returns `FALSE`.
...
linestring is both [`ST_ISCLOSED`](https://docs.cloud.google.com/bigquery/docs/reference/standard-sql/geography_functions#st_isclosed) and
...
the two regions, see [`ST_MAKEPOLYGONORIENTED`](https://docs.cloud.google.com/bigquery/docs/reference/standard-sql/geography_functions#st_makepolygonoriented).
...
[`ST_MAKEPOLYGON`](https://docs.cloud.google.com/bigquery/docs/reference/standard-sql/geography_functions#st_makepolygon) for an alternate polygon constructor, and
...
An alias of [ST_NUMPOINTS](https://docs.cloud.google.com/bigquery/docs/reference/standard-sql/geography_functions#st_numpoints).
...
The following example uses `ST_POINTN`, [`ST_STARTPOINT`](https://docs.cloud.google.com/bigquery/docs/reference/standard-sql/geography_functions#st_startpoint) and
[`ST_ENDPOINT`](https://docs.cloud.google.com/bigquery/docs/reference/standard-sql/geography_functions#st_endpoint) to extract points from a linestring.
...
as [`ST_CONTAINS`](https://docs.cloud.google.com/bigquery/docs/reference/standard-sql/geography_functions#st_contains)`(b, a)`. Note the opposite order of arguments.
