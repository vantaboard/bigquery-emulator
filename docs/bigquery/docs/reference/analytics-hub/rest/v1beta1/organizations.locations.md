# REST Resource: organizations.locations.dataExchanges
...
| ## Methods ||
|---|---|
| ### `https://docs.cloud.google.com/bigquery/docs/reference/analytics-hub/rest/v1beta1/organizations.locations.dataExchanges/list` | Lists all data exchanges from projects in a given organization and location. |