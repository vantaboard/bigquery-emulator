# Method: projects.locations.reservations.getIamPolicy
...
| Parameters ||
|---|---|
| `options` | ``object (`https://docs.cloud.google.com/bigquery/docs/reference/reservations/rest/v1/GetPolicyOptions`)`` OPTIONAL: A `GetPolicyOptions` object for specifying options to `reservations.getIamPolicy`. |
