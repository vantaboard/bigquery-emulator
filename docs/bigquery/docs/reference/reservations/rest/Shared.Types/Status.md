...
| `message` | `string` A developer-facing error message, which should be in English. Any user-facing error message should be localized and sent in the `https://docs.cloud.google.com/bigquery/docs/reference/reservations/rest/Shared.Types/Status#FIELDS.details` field, or localized by the client. |
