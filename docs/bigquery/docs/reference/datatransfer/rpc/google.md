...
- `https://docs.cloud.google.com/bigquery/docs/reference/datatransfer/rpc/google.rpc#google.rpc.Code` (enum)
- `https://docs.cloud.google.com/bigquery/docs/reference/datatransfer/rpc/google.rpc#google.rpc.Status` (message)
...
| Fields ||
|---|---|
| `code` | `int32` The status code, which should be an enum value of `https://docs.cloud.google.com/bigquery/docs/reference/datatransfer/rpc/google.rpc#google.rpc.Code`. |
