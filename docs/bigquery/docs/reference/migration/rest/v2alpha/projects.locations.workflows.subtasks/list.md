...
| JSON representation |
|---|
| ``` { "migrationSubtasks": [ { object (`https://docs.cloud.google.com/bigquery/docs/reference/migration/rest/v2alpha/projects.locations.workflows.subtasks#MigrationSubtask`) } ], "nextPageToken": string } ``` |

| Fields ||
|---|---|
| `migrationSubtasks[]` | ``object (`https://docs.cloud.google.com/bigquery/docs/reference/migration/rest/v2alpha/projects.locations.workflows.subtasks#MigrationSubtask`)`` The migration subtasks for the specified task. |
