...
| JSON representation |
|---|
| ``` { "migrationWorkflows": [ { object (`https://docs.cloud.google.com/bigquery/docs/reference/migration/rest/v2/projects.locations.workflows#MigrationWorkflow`) } ], "nextPageToken": string } ``` |

| Fields ||
|---|---|
| `migrationWorkflows[]` | ``object (`https://docs.cloud.google.com/bigquery/docs/reference/migration/rest/v2/projects.locations.workflows#MigrationWorkflow`)`` The migration workflows for the specified project / location. |
