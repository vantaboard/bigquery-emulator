...
| JSON representation |
|---|
| ``` { "resource": string, "options": { object (`https://docs.cloud.google.com/bigquery/docs/reference/bigqueryconnection/rest/Shared.Types/GetIamPolicyRequest#GetPolicyOptions`) } } ``` |

| Fields ||
|---|---|
| `resource` | `string` REQUIRED: The resource for which the policy is being requested. See [Resource names](https://cloud.google.com/apis/design/resource_names) for the appropriate value for this field. |
| `options` | ``object (`https://docs.cloud.google.com/bigquery/docs/reference/bigqueryconnection/rest/Shared.Types/GetIamPolicyRequest#GetPolicyOptions`)`` OPTIONAL: A `GetPolicyOptions` object for specifying options to `GetIamPolicy`. |
