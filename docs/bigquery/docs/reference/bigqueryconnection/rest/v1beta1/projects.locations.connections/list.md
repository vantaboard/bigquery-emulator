...
The response for `https://docs.cloud.google.com/bigquery/docs/reference/bigqueryconnection/rest/v1beta1/projects.locations.connections/list#google.cloud.bigquery.connection.v1beta1.ConnectionService.ListConnections`.

If successful, the response body contains data with the following structure:

| JSON representation |
|---|
| ``` { "nextPageToken": string, "connections": [ { object (`https://docs.cloud.google.com/bigquery/docs/reference/bigqueryconnection/rest/v1beta1/projects.locations.connections#Connection`) } ] } ``` |

| Fields ||
|---|---|
| `nextPageToken` | `string` Next page token. |
| `connections[]` | ``object (`https://docs.cloud.google.com/bigquery/docs/reference/bigqueryconnection/rest/v1beta1/projects.locations.connections#Connection`)`` List of connections. |
