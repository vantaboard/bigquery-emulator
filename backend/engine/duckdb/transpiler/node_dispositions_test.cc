...
// `local-exec-15-specialized-stubs.plan.md` is the canonical owner of
...
TEST(NodeDispositionTableTest, EveryNodeApplicableDispositionIsReachable) {
  ...
  // `local-exec-15-specialized-stubs.plan.md` introduces (the
...
TEST(NodeDispositionTableTest, EveryUnsupportedRowPointsAtPolicyPlan) {
  ...
  // `local-exec-15-specialized-stubs.plan.md`, per the plan's done
...
TEST(NodeDispositionTableTest, EveryLocalStubRowPointsAtPolicyPlan) {
  ...
  // at `local-exec-15-specialized-stubs.plan.md` so a reader can trace
