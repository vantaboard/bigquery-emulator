...
func TestDDLCreateTableAsSelectRoundTrip(t *testing.T) {
	...
	// engine emits per
	// `.cursor/plans/googlesqlite-01-ddl-catalog.plan.md` Item 5.
...
// `.cursor/plans/googlesqlite-01-ddl-catalog.plan.md` Done Criterion #3,
